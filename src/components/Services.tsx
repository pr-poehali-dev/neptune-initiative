        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div className="text-center mb-6">
              ...
              <div className="text-2xl text-slate-600">150₽</div>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-shadow relative">
            ...
            <div className="text-center mb-6">
              ...
              <div className="text-2xl text-blue-100">200₽</div>
            </div>
            <ul className="space-y-3 mb-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div className="text-center mb-6">
              ...
              <div className="text-5xl font-bold text-slate-900 mb-2">175₴</div>
              <div className="text-2xl text-slate-600">250₽</div>
            </div>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center text-neutral-700">
                <span className="text-green-500 mr-2">✓</span>
